...
type CreateViewResponse struct {
	ID ksid.ID `json:"id" jsonschema:"description=New view identifier"`
}

// UpdateViewResponse is a response from updating a view.
type UpdateViewResponse struct {
	ID ksid.ID `json:"id" jsonschema:"description=View identifier"`
}
...
type UserResponse struct {
	...
	// Current context
	OrganizationID ksid.ID          `json:"organization_id,omitempty" jsonschema:"description=Active organization ID"`
	OrgRole        OrganizationRole `json:"org_role,omitempty" jsonschema:"description=Role in active organization"`
	WorkspaceID    ksid.ID          `json:"workspace_id,omitempty" jsonschema:"description=Active workspace ID"`
...
type WSInvitationResponse struct {
	ID          ksid.ID       `json:"id" jsonschema:"description=Unique invitation identifier"`
	Email       string        `json:"email" jsonschema:"description=Email address of the invitee"`
	WorkspaceID ksid.ID       `json:"workspace_id" jsonschema:"description=Workspace the user is invited to"`
...
type OrganizationResponse struct {
	ID             ksid.ID              `json:"id" jsonschema:"description=Unique organization identifier"`
...
type GitRemoteResponse struct {
	WorkspaceID    ksid.ID `json:"workspace_id" jsonschema:"description=Workspace this remote belongs to"`
...
type CreatePageResponse struct {
	ID ksid.ID `json:"id" jsonschema:"description=New node identifier"`
}
...
type GetNodeTitlesResponse struct {
	Titles map[ksid.ID]string `json:"titles" jsonschema:"description=Map of node ID to title"`
}

// BacklinkInfo represents a page that links to this page.
type BacklinkInfo struct {
	NodeID ksid.ID `json:"node_id" jsonschema:"description=ID of the linking page"`
...
type AdminOrgDetail struct {
	ID             ksid.ID                `json:"id" jsonschema:"description=Organization identifier"`
...
type AdminWorkspaceDetail struct {
	ID           ksid.ID `json:"id" jsonschema:"description=Workspace identifier"`
	OrgID        ksid.ID `json:"org_id" jsonschema:"description=Parent organization ID"`
...
type NotionImportResponse struct {
	WorkspaceID   ksid.ID `json:"workspace_id" jsonschema:"description=ID of the created workspace"`
