...
func (h *ViewHandler) CreateView(ctx context.Context, wsID jsonldb.ID, user *identity.User, req *dto.CreateViewRequest) (*dto.CreateViewResponse, error) {
...
func (h *ViewHandler) UpdateView(ctx context.Context, wsID jsonldb.ID, user *identity.User, req *dto.UpdateViewRequest) (*dto.UpdateViewResponse, error) {
	ws, err := h.Svc.FileStore.GetWorkspaceStore(ctx, wsID)
	if err != nil {
		return nil, dto.InternalWithError("Failed to get workspace", err)
	}
...
func (h *ViewHandler) DeleteView(ctx context.Context, wsID jsonldb.ID, user *identity.User, req *dto.DeleteViewRequest) (*dto.DeleteViewResponse, error) {
	ws, err := h.Svc.FileStore.GetWorkspaceStore(ctx, wsID)
	if err != nil {
		return nil, dto.InternalWithError("Failed to get workspace", err)
	}
