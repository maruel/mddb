...
func (d *AssetDownloader) DownloadAsset(nodeID jsonldb.ID, assetURL string) (string, error) {
	if assetURL == "" {
		return "", nil
	}
...
func (d *AssetDownloader) ProcessMediaBlock(nodeID jsonldb.ID, media *MediaBlock) (string, error) {
	if media == nil {
		return "", nil
	}
...
func (d *AssetDownloader) ProcessFileValue(nodeID jsonldb.ID, fv *FileValue) (string, error) {
	if fv == nil {
		return "", nil
	}
