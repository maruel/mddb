...
func (p *PushSubscription) GetID() rid.ID {
	return p.ID
}
...
type PushSubscriptionService struct {
	...
	byUserID   *jsonldb.Index[rid.ID, *PushSubscription]
...
func NewPushSubscriptionService(tablePath string) (*PushSubscriptionService, error) {
	...
	byUserID := jsonldb.NewIndex(table, func(p *PushSubscription) rid.ID { return p.UserID })
...
func (s *PushSubscriptionService) Create(userID rid.ID, endpoint, p256dh, auth string) (*PushSubscription, error) {
...
func (s *PushSubscriptionService) ListByUser(userID rid.ID) iter.Seq[*PushSubscription] {
...
func (s *PushSubscriptionService) Delete(id rid.ID) error {
