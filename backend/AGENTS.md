...
- `internal/server/gomode.go`: Go Mode discovery and authenticated, workspace-scoped MCP read access.
- `internal/server/gomode_test.go`: Tests authenticated Go Mode MCP reads and embedded voice gateway access.
