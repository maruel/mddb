...
types:
	...
	@echo "// Compatibility aliases" >> frontend/src/types.ts
	@echo "export type AppNode = Node;" >> frontend/src/types.ts
	@echo "export type DataRecord = Record;" >> frontend/src/types.ts
