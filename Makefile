...
types:
	...
	@cat frontend/src/jsonldb.gen.ts | grep -v "Code generated by tygo" | grep -v "source:" >> frontend/src/types.ts
	@cat frontend/src/handlers.gen.ts | grep -v "Code generated by tygo" | grep -v "source:" >> frontend/src/types.ts
	@cat frontend/src/errors.gen.ts | grep -v "Code generated by tygo" | grep -v "source:" >> frontend/src/types.ts
	@echo "" >> frontend/src/types.ts
	@rm frontend/src/models.gen.ts frontend/src/storage.gen.ts frontend/src/jsonldb.gen.ts frontend/src/handlers.gen.ts frontend/src/errors.gen.ts
