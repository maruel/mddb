    ...
    <div class={styles.container}>
      <div class={styles.content}>
        ...
        <section class={styles.section}>
          ...
          <p>
            Welcome to mddb. We are committed to protecting your personal information and your right
        ...
        <section class={styles.section}>
          ...
          <p>
            ...
            the mddb Express interest in obtaining information about us or our products and
            services, when participating in activities on the mddb or otherwise contacting us.
          </p>
          <p>
            The personal information that we collect depends on the context of your interactions
            with us and the mddb, the choices you make and the products and features you use.
          </p>
        </section>
        ...
        <section class={styles.section}>
          ...
          <p>
            We use personal information collected via our mddb for a variety of business purposes
