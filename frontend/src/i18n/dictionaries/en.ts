...
export const dict: Dictionary = {
  ...
  app: {
    title: "mddb",
    tagline: "A seamless markdown-based document and table system",
    logout: "Logout",
    workspace: "Workspace",
    newPage: "New Page",
    newTable: "New Table",
    ...
    expandNode: "Expand {{title}}",
    breadcrumbs: "Breadcrumbs",
    moveNode: "Move page",
    moveNodeHere: "Move page here",
    moveToRoot: "Move page to workspace root",
  ...
  editor: {
    ...
    contentPlaceholder: "Type / for commands...",
    unsaved: "Unsaved",
    history: "History",
  ...
  onboarding: {
    welcome: "Welcome to mddb!",
    letsGetStarted: "Let's get your workspace ready.",
    confirmWorkspaceName: "Confirm Workspace Name",
    workspaceName: "Workspace Name",
    workspaceNameHint: "You can change this name to something more descriptive.",
    nextGitSync: "Next: Git Sync",
    advancedSyncTitle: "Advanced Sync (Optional)",
    advancedSyncHint: "Keep your data safe by synchronizing with a private Git repository.",
    repoUrl: "GitHub/GitLab Repository URL",
    repoUrlPlaceholder: "https://github.com/user/repo.git",
    patLabel: "Personal Access Token",
    patPlaceholder: "ghp_...",
    skipForNow: "Skip for now",
    setupAndFinish: "Setup & Finish",
    defaultOrgName: "{{name}}'s Organization",
    defaultOrgNameFallback: "My Organization",
    defaultWorkspaceName: "{{name}}'s Workspace",
    defaultWorkspaceNameFallback: "Main",
  },
  ...
  settings: {
    ...
    emailColumn: "Email",
    roleColumn: "Role",
    adminOnlyMembers: "Only admins can view member list.",
    ...
    addPasswordHint: "Add a password to enable email/password login.",
    ...
    allowedDomainsHint: "Users with these email domains can join automatically.",
    saveWorkspaceSettings: "Save Workspace Settings",
    // Git sync tab
    gitSynchronization: "Git Synchronization",
    gitSyncHint: "Synchronize your workspace data with an external Git repository.",
    urlColumn: "URL",
    ...
    personalAccessToken: "Personal Access Token (optional)",
    tokenPlaceholder: "ghp_...",
    tokenHint: "Used for authentication when pushing.",
    addRemote: "Add Remote",
    confirmRemoveRemote: "Are you sure you want to remove this remote?",
    // GitHub App sync
    ...
    gitHubAppNotConfigured: "GitHub App not configured on this server",
    autoPush: "Auto-push",
    autoPushHint: "Automatically push changes to the remote after every edit.",
    pull: "Pull",
    syncStatusIdle: "Idle",
    syncStatusSyncing: "Syncing...",
    syncStatusError: "Sync Error",
    syncStatusConflict: "Conflict",
    conflictMessage: "Merge conflict detected. Please resolve manually or pull again.",
    branchColumn: "Branch",
    statusColumn: "Status",
    // Roles
    roleAdmin: "Admin",
    ...
    maxWorkspacesPerOrg: "Max Workspaces",
    maxMembersPerOrg: "Max Members (Org)",
    maxMembersPerWorkspace: "Max Members (Workspace)",
    maxTotalStorageBytes: "Max Total Storage (bytes)",
    maxTablesPerWorkspace: "Max Tables per Workspace",
    maxColumnsPerTable: "Max Columns per Table",
    // Workspace quotas
    workspaceQuotas: "Workspace Quotas",
    maxPages: "Max Pages",
    maxStorageBytes: "Max Storage (bytes)",
    maxRecordsPerTable: "Max Records per Table",
    maxAssetSizeBytes: "Max Asset Size (bytes)",
    serverCeiling: "Server ceiling",
    parentCeiling: "Parent ceiling",
  ...
  table: {
    ...
    noColumns: "No columns. Click + to add a column.",
    loadMore: "Load more",
    ...
    noImage: "No Image",
    noGroup: "No Group",
    addSelectColumn: "Add a select column to use Board view",
    newView: "New View",
    defaultView: "Default",
    all: "All",
    addColumn: "Add Column",
    addRecord: "Add Record",
    addColumnFirst: "Add a column first",
    ...
    optionUsedWarning: "Used by {n} record(s)",
    calendarNotAvailable: "Calendar view is not yet available.",
  },
  ...
  success: {
    ...
    gitHubAppConfigured: "GitHub App remote configured",
  ...
  notionImport: {
    ...
    description: "Create a new workspace from your Notion data.",
    notionToken: "Internal Integration Secret",
    notionTokenPlaceholder: "ntn_... or secret_...",
    setupTitle: "Setup instructions:",
    step1Header: "On the first page:",
    step1a: 'Type name "mddb import"',
    step1b: "Select the workspace to import",
    step1c: 'Select type "Internal"',
    step1d: "Click Save",
    step2Header: "In tab Access:",
    step2a: "Click Edit access",
    step2b: "Select the pages you want to import",
    step3Header: "In tab Configuration:",
    step3a: 'Uncheck "Update content" and "Insert content"',
    step3b: 'Click "Show" next to "Internal Integration Secret" and copy it below',
    createIntegration: "Create a Notion integration",
    ...
    importInProgress: "Notion import in progress...",
    importCompleted: "Notion import completed!",
    importFailed: "Notion import failed",
    importCancelled: "Notion import cancelled",
    pagesImported: "pages",
    databasesImported: "databases",
    recordsImported: "records",
    assetsImported: "assets",
  ...
  notifications: {
    ...
    pushDenied: "Browser notifications are blocked. Enable them in your browser settings.",
    pushEnabled: "Browser notifications enabled",
    preferences: "Notification Preferences",
    channelEmail: "Email",
    channelWeb: "Web",
    typeOrgInvite: "Organization invitations",
    typeWsInvite: "Workspace invitations",
    typeMemberJoined: "Member joined",
    typeMemberRemoved: "Member removed",
    typePageMention: "Page mentions",
    typePageEdited: "Page edits",
  ...
  server: {
    ...
    smtpPasswordHint: "Leave empty to keep existing password",
    ...
    maxPages: "Max Pages",
    maxStorageBytes: "Max Storage (bytes)",
    maxOrganizations: "Max Organizations",
    maxWorkspaces: "Max Workspaces",
    maxUsers: "Max Users",
    maxTotalStorageBytes: "Max Total Storage (bytes)",
    maxAssetSizeBytes: "Max Asset Size (bytes)",
    maxEgressBandwidthBps: "Max Egress Bandwidth (bytes/sec)",
    rateLimits: "Rate Limits",
    rateLimitsHint: "0 means unlimited. Changes take effect immediately.",
    authRatePerMin: "Auth Rate (req/min)",
    writeRatePerMin: "Write Rate (req/min)",
    readAuthRatePerMin: "Read Auth Rate (req/min)",
    readUnauthRatePerMin: "Read Unauth Rate (req/min)",
    saveConfiguration: "Save Configuration",
    configurationSaved: "Configuration saved successfully",
    smtpEnabled: "SMTP Enabled",
    smtpDisabled: "SMTP Disabled",
    dashboard: "Dashboard",
    ...
    readAuthRequests: "Read (Auth)",
    readUnauthRequests: "Read (Unauth)",
    reqPerMin: "req/min",
    refresh: "Refresh",
  },
  ...
  voice: {
    ...
    connectionFailed: "Voice connection failed. Retry to reconnect.",
    ...
    you: "You:",
    setupFailed: "Voice assistant unavailable. Reload to retry.",
  },
};
