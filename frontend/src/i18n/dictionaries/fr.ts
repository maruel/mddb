...
export const dict: Dictionary = {
  ...
  app: {
    ...
    collapseNode: "Réduire {{title}}",
    expandNode: "Développer {{title}}",
    breadcrumbs: "Fil d'Ariane",
    moveNode: "Déplacer la page",
    moveNodeHere: "Déplacer la page ici",
    moveToRoot: "Déplacer la page à la racine de l'espace",
  ...
  editor: {
    ...
    deleteBlocks: "Supprimer {{count}} blocs",
    duplicateBlock: "Dupliquer le bloc",
    duplicateBlocks: "Dupliquer {{count}} blocs",
    indent: "Augmenter le retrait",
    outdent: "Diminuer le retrait",
    convertTo: "Transformer en",
  ...
  settings: {
    ...
    syncStatusConflict: "Conflit",
    conflictMessage: "Conflit de fusion détecté. Veuillez résoudre manuellement ou récupérer à nouveau.",
    branchColumn: "Branche",
    statusColumn: "Statut",
    // Roles
    ...
    maxWorkspacesPerOrg: "Espaces max",
    ...
    confirmRemoveMember:
      "Voulez-vous vraiment retirer ce membre ? Il perdra l'accès à tous les espaces de travail de cette organisation.",
  },
  ...
  table: {
    ...
    insertColumnLeft: "Insérer à gauche",
    ...
    optionPlaceholder: "Nom de l'option",
    deleteOption: "Supprimer l'option",
    optionUsedWarning: "Utilisé par {n} enregistrement(s)",
    calendarNotAvailable: "La vue calendrier n'est pas encore disponible.",
  },
  ...
  success: {
    ...
    pullSuccessful: "Pull réussi",
    gitHubAppConfigured: "Dépôt GitHub App configuré",
  ...
  notifications: {
    ...
    loadMore: "Charger plus",
    enablePush: "Activer les notifications du navigateur",
    pushDenied: "Les notifications du navigateur sont bloquées. Activez-les dans les paramètres de votre navigateur.",
    pushEnabled: "Notifications du navigateur activées",
    preferences: "Préférences de notification",
    channelEmail: "E-mail",
    channelWeb: "Web",
    typeOrgInvite: "Invitations d'organisation",
    typeWsInvite: "Invitations d'espace de travail",
    typeMemberJoined: "Membre rejoint",
    typeMemberRemoved: "Membre retiré",
    typePageMention: "Mentions de page",
    typePageEdited: "Modifications de page",
  ...
  server: {
    ...
    requestMetrics: "Métriques de requêtes",
    serverUptime: "Disponibilité du serveur",
    authRequests: "Requêtes auth",
    writeRequests: "Requêtes écriture",
    readAuthRequests: "Lecture (auth)",
    readUnauthRequests: "Lecture (unauth)",
    reqPerMin: "req/min",
    refresh: "Actualiser",
  },
  ...
  sse: {
    externalChange:
      "Cette page a changé ailleurs. Actualisez pour la charger et abandonner vos modifications non enregistrées.",
  ...
  voice: {
    ...
    connect: "Connecter l’assistant vocal",
    connectionFailed: "La connexion vocale a échoué. Réessayez.",
    endSession: "Terminer la session vocale",
    listening: "Écoute…",
    ...
    settingUpWebRTC: "Configuration de WebRTC…",
    you: "Vous :",
    setupFailed: "Assistant vocal indisponible. Rechargez la page pour réessayer.",
  },
};
