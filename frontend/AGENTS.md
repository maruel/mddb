...
- `docs/BUGS.md`: Frontend Bugs and Issues
...
- `src/api.gen.ts`: Code generated by apiclient. DO NOT EDIT.
...
- `src/components/WorkspaceSettings.tsx`: Settings panel for managing workspace, members, and personal preferences.
...
- `src/types.gen.ts`: Code generated by tygo. DO NOT EDIT.
