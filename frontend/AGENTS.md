...
- `src/components/table/SortMenu.tsx`: Dropdown menu for managing sort rules on a table view.
...
- `src/components/table/ViewToolbar.tsx`: Toolbar with Sort and Filter buttons for table views.
- `src/components/table/sortUtils.test.ts`: Unit tests for sort utility functions (zero mocks).
- `src/components/table/sortUtils.ts`: Pure functions for sort rule manipulation.
